...
class Restaurant(Base):
    ...
    restaurant_image: Mapped[str] = mapped_column(JSON, nullable=True, comment="레스토랑 이미지")
    restaurant_menu: Mapped[str] = mapped_column(JSON, nullable=True, comment="메뉴판 이미지")
    ...
    restaurant_break_time_days: Mapped[str] = mapped_column(String(150), nullable=True, comment='브레이크 타임 날짜 (ex: Mon, Tue, Wed, Thu')
